-- Criar view segura para distribuidores com dados mascarados
...
-- Nova política mais restritiva para a tabela principal
...
-- Política para a view pública (dados mascarados)
CREATE POLICY "Usuários podem ver distribuidores mascarados"
ON public.distributors_public
FOR SELECT
TO authenticated
USING (true);
...
-- Atualizar política de logs para incluir novos tipos de acesso
